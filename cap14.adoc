...
[cols="1,1,1"]
|===
|image::media11x11.png[]
|image::gaussiana11x11.png[]
|image::laplaciano_absolutro11x11.png[]
|===
...
[cols="1,1"]
|===
|image::sobel_horizontal_absoluto11x11.png[]
|image::sobel_vertical11x11.png[]
|===
...
[cols="1,1,1"]
|===
|image::media_gaussiana3x3.png[]
|image::boost3x3.png[]
|image::laplaciano_3x3.png[]
|===

Na 3x3, os filtros média e gaussiano obtiveram o mesmo resultado, enquanto à medida que foram aumentando as matrizes, o borrão no filtro média aumentava, com o filtro gaussiano corringindo esse defeito. O efeito boost também é aplicado (que é a imagem do centro), que perde seu efeito no decorrer do aumento das matrizes. Os efeitos vistos nas matrizes de Sobel encontram-se abaixo:

[cols="1,1"]
|===
|image::sobel_verticala3x3.png[]
|image::sobel_horizontal3x3.png[]
|===
